...
<sectione>
			...
			<br><br>
		   <div align="center">Creation d'une Tache</div>
		  <p>
			...
			<form action="index" method="post" class="niceform">
                ...
                <fieldset>
                       ...
                       <center><label><font color="#090">${succes}</font></label></center>
                        ...
                        <dt><label for="num">Libelle<font color="red">*</font></label></dt>
                        <dd><input type="text" name="num" id="" size="25" /></dd>
                    </dl>
                    
					<dl>
			             <dt><label for="val">Statut </label></dt>
                     ...
                     <dl >
                     <dt><a href="ListeTache.jsp">voir</a></dt>
                    <dd><input type="submit" name="operation" id="" value="Valider" /></dd>
                     </dl>
