...
<section>
			<h1>Menu</h1>
			<br>
			<p><a href="index.jspjsp" align ="right">Accueil</a></p>
...
<sectione>
			...
			<br>
		  <div align ="center">  Creation d'une Vague</div>
		  <p> 
		  
			<form action="CreerVague" method="post" class="niceform">
         
                <fieldset>
                 	<center><label><font color="#900">${erreur}</font></label></center>
                    <center><label><font color="#090">${succes}</font></label></center>
                    <dl>
                        <dt><label for="nom">Intitule<font color="red">*</font></label></dt>
                        <dd><input type="text" name="nom" id="" size="25" /></dd>
                    </dl>
                    <dl>
                        <dt><label for="nom">DateDebut <font color="red">*</font></label></dt>
                        <dd><input type="date"/></dd>
                    </dl>
                     <dl>
                        <dt><label for="nom">DateFin <font color="red">*</font></label></dt>
                        <dd><input type="date"/></dd>
                    </dl>
                    ...
                    <br/><br/><br/><br/>
                     ...
                     <dl>
                     <dt><a href="ListeVague.jsp">voir</a></dt>
        ...
        Valid  | <a href="ConnexionAdmin.jsp" align ="right">Admin</a>
</footer>
