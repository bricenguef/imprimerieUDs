...
<section>
			...
			<p><a href="connexionDmin.jsp" align ="right">Espace Personnel</a></p>
...
<sectione>
		  ...
		  <table>
		      <caption> Liste des Taches</caption>
		  ...
		  <tbody>
			...
			<c:forEach items="${sessionScope.ListeTache}" var="Tache" >
 			<tr>
			   <td> <c:out value="${Tache.Intitule}"/></td>
