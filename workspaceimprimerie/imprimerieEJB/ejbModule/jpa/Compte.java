...
@NamedQueries({
    ...
    @NamedQuery(name = "Compte.findByActive", query = "SELECT c FROM Compte c WHERE c.active = :active")})
public class Compte implements Serializable {
    ...
    public Compte(Integer idcompte, String login, String password, String active) {
        this.idcompte = idcompte;
        this.login = login;
    ...
    public String toString() {
        return "jpa.Compte[ idcompte=" + idcompte + " ]";
    }
